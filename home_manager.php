...
<header>
	<div class="container agile-banner_nav">
		<nav class="navbar navbar-expand-lg navbar-light bg-light">
			...
			<h1><a class="navbar-brand" href="home_manager.php">IITJ <span class="display"></span></a></h1>
				...
				<li class="visible">
					<div class="svg-wrapper">
						<svg viewBox="0 0 1400 800">
							...
							<image height='800px' width="1400px" clip-path="url(#cd-image-1)" xlink:href="web_home/images/iitj.png"></image>
						</svg>
					</div>  
				...
				<li class="next-slide">
					<div class="svg-wrapper">
						<svg viewBox="0 0 1400 800">
							...
							<image height='800px' width="1400px" clip-path="url(#cd-image-2)" xlink:href="web_home/images/hostel_vector.png"></image>
						</svg>
					</div>  
				...
				<li>
					<div class="svg-wrapper">
						<svg viewBox="0 0 1400 800">
							...
							<image height='1920px' width="1080px" clip-path="url(#cd-image-3)" xlink:href="web_home/images/hostel1.jpg"></image>
						</svg>
					</div>  
					<div class="cd-radial-slider-content text-center">
						<div class="wrapper">
...
<footer class="py-5">
	<div class="container py-md-5">
		<div class="footer-logo mb-5 text-center">
			<a class="navbar-brand"  href="https://iitj.ac.in/" target="_blank">IIT<span class="display"> JODHPUR</span></a>
		</div>
